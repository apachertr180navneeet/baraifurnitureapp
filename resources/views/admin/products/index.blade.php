    ...
    $('#addColorBtn').click(() => {
        ...
        $('#colorContainer').append(`
            <div class="color-row" id="colorRow${colorCount}">
                <input type="text" name="colors[${colorCount}][color_name]" class="form-control" placeholder="Color Name">
    ...
    $('#editAddColorBtn').click(() => {
        ...
        $('#editColorContainer').append(`
            <div class="color-row" id="editColorRow${editColorCount}">
                <input type="text" name="colors[${editColorCount}][color_name]" class="form-control" placeholder="Color Name">
        ...
        $.get(url, function(data){
            ...
            if(data.colors){
                data.colors.forEach((color, index)=>{
                    ...
                    $('#editColorContainer').append(`
                        <div class="color-row" id="editColorRow${editColorCount}">
                            <input type="text" name="colors[${editColorCount}][color_name]" class="form-control" value="${color.color_name}" placeholder="Color Name">
